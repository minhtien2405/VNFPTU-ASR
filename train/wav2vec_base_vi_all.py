...
class TrainingConfig:
	...
	hub_model_id: str = "minhtien2405/wav2vec2-base-vi"
	dataset_id: str = "nguyendv02/ViMD_Dataset"
	output_dir: str = "./logs/wav2vec2-base-vi"
	cache_dir: str = "./cache"
	log_dir: str = "./logs"
	model_save_dir: str = "./models/wav2vec2-base-vi"
	...
	run_name: str = f"wav2vec2_finetune_vi_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
def main():
	...
	try:
		...
		wer_history_path = os.path.join(config.output_dir, "wav2vec_base_all_vi_250h_wer_history.json")
		...
		trainer.push_to_hub(
			commit_message="Fine-tuned Wav2Vec2_250h on ViMD All region with layer freezing",
