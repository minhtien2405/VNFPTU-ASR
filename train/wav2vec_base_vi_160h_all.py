...
class TrainingConfig:
	...
	run_name: str = f"wav2vec2_finetune_vi_160h_all_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
def main():
	...
	try:
		...
		wer_history_path = os.path.join(config.output_dir, "wav2vec_base_all_vi_160h_wer_history.json")
