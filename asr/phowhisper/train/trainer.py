...
class Trainer:
    ...
    def train(self):
        ...
        model_dir = os.path.join(os.getcwd(), "models", f"phowhisper-medium-{self.config.region.lower()}-vi")
        ...
        self.trainer.push_to_hub(
            commit_message=f"Fine-tuned PhoWhisper medium with WhisperX chunking on ViMD ({self.config.region})",
